  ...
  return ( 
    ...
    <div className='flex h-full flex-col py-6 w-full justify-center items-center px-6 '>
        ...
        <div className='flex w-[60%] justify-around mt-6 cursor-pointer'>
            ...
            <div className='h-[36px] w-[36px] rounded-full bg-slate-400 items-center justify-center flex' ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="red" class="size-6">
